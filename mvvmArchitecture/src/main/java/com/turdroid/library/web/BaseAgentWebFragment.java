...
import com.turdroid.library.base.BaseFragment;
...
//                .addJavaObject("AndroidWebView", new AndroidInterface(mAgentWeb, mActivity));
    }
    ...
    protected abstract @ColorInt int getIndicatorColor();
